export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxcc5f7b346c113abc",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "4a9e8ffec2aa7aa9cac997840051e79b",
  ...
  USERS: [
    {
      ...
      id: "oJg1R6XdOJxUtiqhRopctju-VRjs，oJg1R6cpfgj9K5ffapEU2A7UAbf4",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "EABa80Ny7M4UxnFrtFXS_3SZR5Su_3VwUqwhVIqFvXY",
      // 所在省份
      province: "浙江",
      // 所在城市
      city: "绍兴",
